using SoftCheck.Service.Services;
using Microsoft.Extensions.Hosting.WindowsServices;

var builder = Host.CreateDefaultBuilder(args)
    .UseWindowsService(options =>
    {
        options.ServiceName = "SoftCheck Agent";
    })
    ...
    .ConfigureLogging(logging =>
    {
        ...
        {
            eventLogSettings.SourceName = "SoftCheck Agent";
        });
    })
...
if (passiveMode)
{
    logger.LogInformation("SoftCheck Agent iniciando en MODO PASIVO...");
...
{
    logger.LogInformation("SoftCheck Agent iniciando en MODO ACTIVO...");
}
...
{
    logger.LogCritical(ex, "Error crítico en SoftCheck Agent");
    throw;
} 
